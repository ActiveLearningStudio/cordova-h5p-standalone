                ...
                return (
                  ...
                  le(function (o, a, s, c) {
                    var l,
                      ...
                      y = n ? (i || (o ? e : h || r) ? [] : a) : v;
                    if ((n && n(v, y, s, c), r))
                      for (l = Ce(y, p), r(l, [], s, c), u = l.length; u--; )
                        (d = l[u]) && (y[p[u]] = !(v[p[u]] = d));
                    if (o) {
                      if (i || e) {
                        if (i) {
                    ...
                    } else (y = Ce(y === a ? y.splice(h, y.length) : y)), i ? i(null, a, y, c) : N.apply(a, y);
                  })
                );
              }
              function Te(e) {
                    ...
                    i = {
                      ...
                      then: function (e, n, i) {
                        ...
                        return T.Deferred(function (r) {
                          t[0][3].add(a(0, r, y(i) ? i : M, r.notifyWith)),
                            t[1][3].add(a(0, r, y(e) ? e : M)),
                            t[2][3].add(a(0, r, y(n) ? n : B));
                        }).promise();
                      },
                      promise: function (e) {
      ...
      (() => {
        ...
        var m = (function () {
          function e(t, n) {
            ...
            n.downloadUrl && (r.exportUrl = y(n.downloadUrl));
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  e.forEach(function (e) {
                    n.add(e.libraryPath, e.dependencies),
                      e.preloadedCss &&
                        ((r[e.libraryPath] = r[e.libraryPath]
                          ? r[e.libraryPath]
                          : []),
                        e.preloadedCss.forEach(function (n) {
                          r[e.libraryPath].push(
                            ""
                              .concat(t.librariesPath, "/")
                      ...
                      e.preloadedJs &&
                        ((i[e.libraryPath] = i[e.libraryPath]
                          ? i[e.libraryPath]
                          : []),
                        e.preloadedJs.forEach(function (n) {
                  ...
                  return (
                    n
                      ...
                      .reverse()
                      .forEach(function (e) {
                        Array.prototype.push.apply(o, r[e]),
